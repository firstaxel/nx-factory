      ...
      <main className="flex flex-col w-full">
        ...
        <section className="relative flex flex-col items-center justify-center px-4 pt-20 pb-16 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center gap-6">
            ...
            <p className="text-lg text-fd-muted-foreground max-w-lg">
              One CLI to scaffold an Nx workspace with a shared shadcn/ui component
              library, Tailwind v4, and production-ready auth — for any number of apps.
            </p>
        ...
        <section className="border-t px-4 py-14">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-semibold text-center mb-10">Up and running in 4 steps</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {STEPS.map(({ n, title, code }) => (
                ...
                >
                  ...
                  <code className="text-xs font-mono text-fd-muted-foreground break-all">{code}</code>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="border-t px-4 py-14 bg-fd-secondary/30">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl font-semibold text-center mb-10">Everything included</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {FEATURES.map(({ icon, title, desc }) => (
                ...
                >
                  ...
                  <span className="text-xs text-fd-muted-foreground leading-relaxed">{desc}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="border-t px-4 py-14">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-sm text-fd-muted-foreground mb-10">
              Every command supports <code className="text-xs bg-fd-secondary px-1.5 py-0.5 rounded">--dry-run</code> and <code className="text-xs bg-fd-secondary px-1.5 py-0.5 rounded">--yes</code>.
            </p>
        ...
        <section className="border-t px-4 py-14 bg-fd-secondary/30">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-xl font-semibold text-center mb-2">Stay connected</h2>
            <p className="text-center text-sm text-fd-muted-foreground mb-10">
